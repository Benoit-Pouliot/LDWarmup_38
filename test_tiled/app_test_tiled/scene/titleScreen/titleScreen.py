...
from test_tiled.app_test_tiled.sprites.GUI.menu.menu import Menu
from test_tiled.app_test_tiled.scene.titleScreen.eventHandlerTitleScreen import EventHandlerTitleScreen
...
class TitleScreen:
    ...
    def startGame(self):
        ...
        self.gameData.mapData = MapData("example_tiled", "InZone_01")
